...
if (stripos($headers[0], '200 OK') > 0) {
    ...
    //$x = str_replace('class="external text" href="https://', 'target="_blank" class="external text" href="https://webot.org/referral.php?nofollow=', $x);
    $x = str_replace('>Coordinates</a>:', '><br/><b>' . $search . ' Latitude and Longitude:</b></a><br/>', $x);
    $x = str_replace('Draft:', '', $x);
    $x = str_replace('rel="nofollow"', '', $x);
    $x = str_replace('<a', "\n<a", $x);
    $x = str_replace('Jump to search', '', $x);
    if ($stock)
